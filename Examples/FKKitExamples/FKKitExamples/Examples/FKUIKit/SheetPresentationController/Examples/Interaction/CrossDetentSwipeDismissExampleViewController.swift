...
/// Demonstrates ``FKSheetPresentationConfiguration/SheetConfiguration/crossDetentSwipeDismissPolicy``.
///
...
final class CrossDetentSwipeDismissExampleViewController: FKSheetPresentationExamplePageViewController {
  ...
  private func presentDemoSheet() {
    let policy: FKSheetPresentationConfiguration.SheetConfiguration.CrossDetentSwipeDismissPolicy =
    ...
    if edgeSegmentIndex == 0 {
      configuration = FKSheetPresentationExampleHelpers.bottomSheetConfiguration()
    } else {
      configuration = FKSheetPresentationExampleHelpers.topSheetConfiguration()
    }
