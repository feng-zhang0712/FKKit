...
final class SwipeToDismissExampleViewController: FKSheetPresentationExamplePageViewController {
  ...
  override func viewDidLoad() {
    ...
    addPrimaryButton(title: "Present") { [weak self] in
      ...
      _ = FKSheetPresentationExampleHelpers.present(from: self, title: "Swipe to dismiss", configuration: configuration)
    }
  }
}
