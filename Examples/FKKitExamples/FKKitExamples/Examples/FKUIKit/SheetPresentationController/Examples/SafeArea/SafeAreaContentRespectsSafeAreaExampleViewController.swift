...
final class SafeAreaContentRespectsSafeAreaExampleViewController: FKSheetPresentationExamplePageViewController {
  override func viewDidLoad() {
    ...
    addPrimaryButton(title: "Present (bottom sheet)") { [weak self] in
      ...
      _ = FKSheetPresentationExampleHelpers.present(from: self, title: "contentRespectsSafeArea", configuration: configuration)
    }
  }
}
