...
final class CenterModalBasicsExampleViewController: FKSheetPresentationExamplePageViewController {
  ...
  override func viewDidLoad() {
    ...
    addPrimaryButton(title: "Present") { [weak self] in
      ...
      _ = FKSheetPresentationExampleHelpers.present(from: self, title: "Center modal", configuration: configuration)
    }
  }
}
