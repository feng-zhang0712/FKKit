...
final class BottomSheetBasicsExampleViewController: FKSheetPresentationExamplePageViewController {
  override func viewDidLoad() {
    ...
    addPrimaryButton(title: "Present") { [weak self] in
      ...
      _ = FKSheetPresentationExampleHelpers.present(from: self, title: "Bottom sheet", configuration: configuration)
    }
  }
}
