...
final class RotationResilienceExampleViewController: FKSheetPresentationExamplePageViewController {
  ...
  override func viewDidLoad() {
    ...
    addPrimaryButton(title: "Present anchored panel") { [weak self] in
      ...
      _ = FKSheetPresentationExampleHelpers.present(from: self, title: "Rotate the device", configuration: configuration)
    }
  }
}
