...
final class ReduceMotionCompatibleAnimationExampleViewController: FKSheetPresentationExamplePageViewController {
  ...
  override func viewDidLoad() {
    ...
    addPrimaryButton(title: "Present (auto choose)") { [weak self] in
      ...
      _ = FKSheetPresentationExampleHelpers.present(from: self, title: "Reduce Motion aware", configuration: configuration)
    }
