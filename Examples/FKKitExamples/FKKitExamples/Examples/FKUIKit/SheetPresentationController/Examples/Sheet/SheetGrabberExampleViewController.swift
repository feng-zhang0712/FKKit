...
final class SheetGrabberExampleViewController: FKSheetPresentationExamplePageViewController {
  ...
  override func viewDidLoad() {
    ...
    addPrimaryButton(title: "Present") { [weak self] in
      ...
      _ = FKSheetPresentationExampleHelpers.present(from: self, title: "Grabber", configuration: configuration)
    }
  }
}
