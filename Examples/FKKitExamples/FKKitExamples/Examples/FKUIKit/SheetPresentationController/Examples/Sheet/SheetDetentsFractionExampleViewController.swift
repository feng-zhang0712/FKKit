...
final class SheetDetentsFractionExampleViewController: FKSheetPresentationExamplePageViewController {
  ...
  override func viewDidLoad() {
    ...
    addPrimaryButton(title: "Present") { [weak self] in
      ...
      _ = FKSheetPresentationExampleHelpers.present(from: self, title: "Fraction detents", configuration: configuration)
    }
  }
}
