...
final class ZeroDimBackdropBehaviorExampleViewController: FKSheetPresentationExamplePageViewController {
  ...
  private func selectedBehavior() -> FKSheetPresentationConfiguration.ZeroDimBackdropBehavior {
