...
@MainActor
class FKSheetPresentationBlurExampleBaseViewController: FKSheetPresentationExamplePageViewController {
  ...
  func applyCommonBlurConfiguration(to configuration: inout FKSheetPresentationConfiguration) {
