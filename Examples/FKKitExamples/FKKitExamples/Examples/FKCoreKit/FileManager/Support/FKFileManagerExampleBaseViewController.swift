...
/// Scrollable action list and monospace log shared by FileManager scenario demos.
@MainActor
class FKFileManagerExampleBaseViewController: UIViewController {
  ...
  func appendLog(_ line: String) {
    let stamp = DateFormatter.fileManagerExampleFormatter.string(from: Date())
...
private extension DateFormatter {
  static let fileManagerExampleFormatter: DateFormatter = {
