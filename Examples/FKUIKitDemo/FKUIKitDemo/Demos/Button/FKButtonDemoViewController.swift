//
//  FKButtonDemoViewController.swift
//  FKUIKitDemo
//
...
final class FKButtonDemoViewController: UIViewController {
  enum DemoMetrics {
  ...
  private lazy var rootStackView: UIStackView = {
    ...
    stack.spacing = DemoMetrics.spacing
...
private extension FKButtonDemoViewController {
  ...
  func makeTextOnlyDemo() -> UIView {
    ...
    NSLayoutConstraint.activate([
      normalBtn.heightAnchor.constraint(equalToConstant: DemoMetrics.buttonHeight),
      selectedBtn.heightAnchor.constraint(equalToConstant: DemoMetrics.buttonHeight),
      highlightedBtn.heightAnchor.constraint(equalToConstant: DemoMetrics.buttonHeight),
      disabledBtn.heightAnchor.constraint(equalToConstant: DemoMetrics.buttonHeight)
    ])
    return stack
  }
  ...
  func makeCompositionDemo() -> UIView {
    let stack = UIStackView()
    stack.axis = .vertical
    stack.alignment = .center
    stack.spacing = 10
    ...
    NSLayoutConstraint.activate([
      leading.heightAnchor.constraint(equalToConstant: DemoMetrics.buttonHeight),
      both.heightAnchor.constraint(equalToConstant: DemoMetrics.buttonHeight),
      trailing.heightAnchor.constraint(equalToConstant: DemoMetrics.buttonHeight),
      disabled.heightAnchor.constraint(equalToConstant: DemoMetrics.buttonHeight)
    ])
    return stack
  }
}
