//
//  FKPresentationDemoViewController.swift
//  FKUIKitDemo
//
...
final class FKPresentationDemoViewController: UIViewController {
  ...
  @objc private func onShowUIViewContent() {
    ...
    let content = DemoPresentationContentView()
  ...
  @objc private func onShowUIViewControllerContent() {
    presentation.configuration = currentConfiguration(animated: true)
    let content = DemoPresentationContentViewController()
...
private final class DemoPresentationContentView: UIView {
...
private final class DemoPresentationContentViewController: UIViewController {
  override func viewDidLoad() {
    super.viewDidLoad()
...
extension FKPresentationDemoViewController: FKPresentationDelegate {
