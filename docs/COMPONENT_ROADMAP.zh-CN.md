...
**详细设计（活文档，与代码对齐）：** [FKListKit_DESIGN.zh-CN.md](FKListKit_DESIGN.zh-CN.md)
...
**详细设计（活文档，与代码对齐）：** [FKAlert_DESIGN.zh-CN.md](FKAlert_DESIGN.zh-CN.md)
...
| ID | 主题 | 问题 / 风险 | 缓解措施 |
|----|------|-------------|----------|
| R1 | **范围膨胀** | FKListKit 可能膨胀为完整 App 框架。 | v1 已交付薄基类；预设增量 / CellKit 映射见 [FKListKit 设计](FKListKit_DESIGN.zh-CN.md) §26。 |
...
3. `FKAlert` 与 `FKBusinessAlertManager` **v1 长期共存**；BusinessKit 后端开关见 [FKAlert 设计](FKAlert_DESIGN.zh-CN.md) §23。
