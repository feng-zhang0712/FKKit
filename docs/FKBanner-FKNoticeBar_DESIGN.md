...
**状态：** 草案  
**路线图引用：** [COMPONENT_ROADMAP.md](COMPONENT_ROADMAP.md) §2.1  
**缺口分析引用：** [COMPONENT_GAP_ANALYSIS.md](COMPONENT_GAP_ANALYSIS.md) §8.1  
...
| 排除 | 说明 |
|------|------|
| 系统 APNs 推送 UI | 本地通知走 Tier 3 **`FKLocalNotificationManager`** — 见 [FKLocalNotificationManager_DESIGN.md](FKLocalNotificationManager_DESIGN.md) |
