...
**关联文档：** [COMPONENT_ROADMAP.zh-CN.md](COMPONENT_ROADMAP.zh-CN.md)（迭代路线图与设计约束）
...
本文档侧重**现状分析**；具体 API 草案、目录规范、交付检查清单见 [COMPONENT_ROADMAP.zh-CN.md](COMPONENT_ROADMAP.zh-CN.md) 及各 `*_DESIGN.zh-CN.md`。
...
[COMPONENT_ROADMAP.zh-CN.md](COMPONENT_ROADMAP.zh-CN.md) 初版（2026-06-08）基线中标记为缺口、**现已落地**的主要项：
...
与 [COMPONENT_ROADMAP.zh-CN.md — 分阶段发布计划](COMPONENT_ROADMAP.zh-CN.md#分阶段发布计划) 对齐，并结合**当前已交付项**更新如下：
...
| [FKFileManager_ENHANCEMENT_DESIGN.zh-CN.md](FKFileManager_ENHANCEMENT_DESIGN.zh-CN.md) | 文件模块增强（ZIP、后台传输） |
| [COMPONENT_ROADMAP.zh-CN.md](COMPONENT_ROADMAP.zh-CN.md) | 完整路线图、约束、交付检查清单 |
| [FKListKit_DESIGN.zh-CN.md](FKListKit_DESIGN.zh-CN.md) | Diffable 列表基础设施设计 |
| [FKFormControls_DESIGN.zh-CN.md](FKFormControls_DESIGN.zh-CN.md) | 表单控件族设计 |
| [FKAlert_DESIGN.zh-CN.md](FKAlert_DESIGN.zh-CN.md) | 居中 Alert 设计 |
| [FKImageLoader-FKImageView_DESIGN.zh-CN.md](FKImageLoader-FKImageView_DESIGN.zh-CN.md) | 图片加载（已交付） |
| [FKSearchBar-FKSearchField_DESIGN.zh-CN.md](FKSearchBar-FKSearchField_DESIGN.zh-CN.md) | 搜索栏（已交付） |
| [FKWebView_DESIGN.zh-CN.md](FKWebView_DESIGN.zh-CN.md) | WebView（已交付） |
| [FKBiometricAuth_DESIGN.zh-CN.md](FKBiometricAuth_DESIGN.zh-CN.md) | 生物识别（已交付） |
| [FKChip-FKTag-FKChipGroup_DESIGN.zh-CN.md](FKChip-FKTag-FKChipGroup_DESIGN.zh-CN.md) | Chip/Tag（已交付） |
| [FKAvatar-FKAvatarGroup-FKPresenceIndicator_DESIGN.zh-CN.md](FKAvatar-FKAvatarGroup-FKPresenceIndicator_DESIGN.zh-CN.md) | Avatar（已交付） |
| [FKCarousel-FKImageBanner_DESIGN.zh-CN.md](FKCarousel-FKImageBanner_DESIGN.zh-CN.md) | 轮播（已交付） |
| [FKPhotoPicker_DESIGN.zh-CN.md](FKPhotoPicker_DESIGN.zh-CN.md) | 相册选择（已交付） |
| [FKStepIndicator-FKTimeline_DESIGN.zh-CN.md](FKStepIndicator-FKTimeline_DESIGN.zh-CN.md) | 步骤条/时间线（已交付） |
| [FKBusinessKit-Widgets-Integration_DESIGN.zh-CN.md](FKBusinessKit-Widgets-Integration_DESIGN.zh-CN.md) | BusinessKit × Widgets 组合 |
