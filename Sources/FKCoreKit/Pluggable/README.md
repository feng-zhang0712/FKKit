...
Protocol contracts for **pluggable** iOS app infrastructure. Sources live under `Sources/FKCoreKit/Pluggable/` and ship as part of the **`FKCoreKit`** product (interfaces and shared value types only—no implementations).
