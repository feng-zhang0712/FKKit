...
extension FKPermissionError: LocalizedError {
  public var errorDescription: String? {
    switch self {
    case .prePromptCancelled:
      return FKI18n.string("fkcore.permission.error.pre_prompt_cancelled")
    case .unavailable:
      return FKI18n.string("fkcore.permission.error.unavailable")
...
public struct FKPermissionPrePrompt: Sendable, Equatable, Hashable {
  ...
  public init(
    title: String,
    message: String,
    confirmTitle: String = FKI18n.string("fkcore.common.continue"),
    cancelTitle: String = FKI18n.string("fkcore.common.not_now")
  ) {
    self.title = title
