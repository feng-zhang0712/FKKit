...
/// Settings row with leading icon and trailing chevron (D-04).
@MainActor
public final class FKCellIconDisclosureCell: UITableViewCell, FKCellReusable {
  public typealias ViewModel = FKCellIconDisclosureRow
  ...
  /// Applies an icon disclosure configuration with default appearance.
  public func apply(_ configuration: FKCellIconDisclosureConfiguration) {
    apply(configuration, appearance: .default)
  }

  /// Applies an icon disclosure configuration with explicit appearance tokens.
  public func apply(
    _ configuration: FKCellIconDisclosureConfiguration,
    ...
    layout.contentStack.setTitle(configuration.title, numberOfLines: 1)
  ...
  public func configure(with viewModel: FKCellIconDisclosureRow) {
