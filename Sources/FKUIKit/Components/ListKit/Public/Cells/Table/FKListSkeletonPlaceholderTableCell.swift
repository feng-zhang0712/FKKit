...
/// Placeholder table cell with feed-style skeleton blocks for ``FKListSkeletonPolicy/presetRows(count:)``.
@MainActor
public final class FKListSkeletonPlaceholderTableCell: UITableViewCell, FKListTableCellConfigurable {
  public typealias Item = FKListSkeletonPlaceholder.Context

  public static let reuseIdentifier = FKListSkeletonPlaceholder.cellTypeIdentifier
  ...
  private func setup() {
    ...
    NSLayoutConstraint.activate([
      ...
      contentView.heightAnchor.constraint(greaterThanOrEqualToConstant: FKListSkeletonPlaceholder.recommendedItemHeight),
    ])
  }
