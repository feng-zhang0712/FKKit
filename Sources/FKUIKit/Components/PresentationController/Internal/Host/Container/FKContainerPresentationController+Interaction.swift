...
extension FKContainerPresentationController {
  ...
  func presentationTransitioningDelegate() -> FKPresentationTransitioningDelegate? {
    presentedViewController.transitioningDelegate as? FKPresentationTransitioningDelegate
  }
